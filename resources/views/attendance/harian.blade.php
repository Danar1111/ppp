...
<head>
    ...
    <title>Presensi Harian Kantor - PPP</title>
    <!-- Google Fonts -->
...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-4 font-sans text-slate-800">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-br from-brand-greenDark to-brand-green p-6 text-center text-white relative">
            ...
            <h1 class="text-lg font-bold">SIP - PRESENSI HARIAN KANTOR</h1>
            <p class="text-xs text-brand-gold font-semibold uppercase tracking-wider mt-1">{{ $office['name'] }}</p>
        </div>
        ...
        <div class="p-6">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-semibold text-amber-800">
                                {{ session('info') ?? 'Anda sudah melakukan presensi harian kantor hari ini.' }}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <form id="attendanceForm" action="{{ route('absen.harian.submit', ['level' => $level, 'code' => $code]) }}" method="POST" class="space-y-4">
                ...
                <div class="text-xs text-slate-400 text-center leading-relaxed">
                    * Sistem akan memverifikasi lokasi GPS Anda untuk memastikan Anda berada dalam radius 50 meter dari kantor sekretariat.
                </div>
                ...
                navigator.geolocation.getCurrentPosition(
                    function (position) {
                        ...
                        if (submitBtn) {
                            ...
                            submitBtn.innerText = "Kirim Kehadiran Harian";
